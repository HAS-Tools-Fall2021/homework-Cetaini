...
# question 1
plt.figure(0)
plt.plot(flow_data[11930:,3])
np.mean(flow_data[11930:,3])
np.mean(flow_data[11940:,3])
np.mean(flow_data[11945:,3])

mybins = np.linspace(0, 1000, num=60)
plt.figure(1)
...
plt.figure(2)
plt.hist(flow_data[(flow_data[:,1]==9) & (flow_data[:,0]==2021),3], bins = mybins)
plt.title('Streamflow')
plt.xlabel('Flow [cfs]')
plt.ylabel('Count')

print(np.quantile(flow_data[11940:,3], q=[0,0.1, 0.5, 0.9]))
np.median(flow_data[11944:,3])
...
# question 3
# total number
flow_count = np.sum((flow_data[:,3] > 92) & (flow_data[:,1]==7))
print(flow_count)
# percentage
flow_count = np.sum((flow_data[:,3] > 92) & (flow_data[:,1]==7))/np.sum(flow_data[:,1]==7)*100
print(flow_count)
...
# in or before 2000
# total number
flow_count = np.sum((flow_data[:,3] > 92) & (flow_data[:,1]==7) & (flow_data[:,0]<=2000))
print(flow_count)
# percentage
flow_count = np.sum((flow_data[:,3] > 92) & (flow_data[:,1]==7) & (flow_data[:,0]<=2000))/np.sum((flow_data[:,1]==7) & (flow_data[:,0]<=2000))*100
print(flow_count)
# in or after 2010
# total number
flow_count = np.sum((flow_data[:,3] > 92) & (flow_data[:,1]==7) & (flow_data[:,0]>=2010))
print(flow_count)
# percentage
flow_count = np.sum((flow_data[:,3] > 92) & (flow_data[:,1]==7) & (flow_data[:,0]>=2010))/np.sum((flow_data[:,1]==7) & (flow_data[:,0]>=2010))*100
print(flow_count)

# %%
# question 5
first_half = np.mean(flow_data[(flow_data[:,2]<=15) & (flow_data[:,1]==9),3])
second_half = np.mean(flow_data[(flow_data[:,2]>15) & (flow_data[:,1]==9),3])
